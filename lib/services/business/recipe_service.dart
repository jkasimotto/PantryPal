...
class RecipeService {
  ...
  Future<void> addIngredientToRecipe(
    ...
    firestoreService.updateDocument(updatedRecipe, 'recipes');
    // TODO: We need to set the ingredient's meta id for the icon path.
    cloud_functions.addIngredientIconPathToRecipe(updatedRecipe.meta.id);
  }
