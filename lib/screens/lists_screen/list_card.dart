...
import 'package:flutter_recipes/screens/lists_screen/list_detail_screen.dart';
...
class ListCard extends StatelessWidget {
  ...
  ListCard({Key? key, required this.list, required this.onChanged}) : super(key: key);
    ...
    return Card(
      ...
      child: ListTile(
        ...
        title: InkWell(
          ...
          child: Text(list.data.recipeTitles.join(', ')),
        ),
      ),
    );
  }
