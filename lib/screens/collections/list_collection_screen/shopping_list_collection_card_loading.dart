...
import 'package:flutter_recipes/shared/progress/linear_progress_with_widget.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';

class ShoppingListCollectionCardLoading extends StatefulWidget {
  final ShoppingList list;

  const ShoppingListCollectionCardLoading({Key? key, required this.list})
      : super(key: key);

  @override
  _ShoppingListCollectionCardLoadingState createState() =>
      _ShoppingListCollectionCardLoadingState();
}

class _ShoppingListCollectionCardLoadingState
    extends State<ShoppingListCollectionCardLoading>
