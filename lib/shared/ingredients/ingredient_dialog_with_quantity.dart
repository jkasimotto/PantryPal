...
import 'package:flutter_recipes/services/firebase/cloud_functions_service.dart'
    as cloud_functions;
import 'package:flutter_recipes/shared/ingredients/ingredient_icon.dart'; // Import the buildIngredientIcon function

class IngredientDialogWithQuantity extends StatefulWidget {
  ...
  const IngredientDialogWithQuantity({
    super.key,
  ...
  @override
  _IngredientDialogWithQuantityState createState() =>
      _IngredientDialogWithQuantityState();
}

class _IngredientDialogWithQuantityState
    extends State<IngredientDialogWithQuantity> {
